...
export class BrowserBridge implements IBrowserFactory {
  ...
  async connect(opts: { timeout?: number; session?: string; idleTimeout?: number; contextId?: string; preferredContextId?: string; windowMode?: 'foreground' | 'background'; surface?: 'browser' | 'adapter'; siteSession?: 'ephemeral' | 'persistent'; controlKey?: string; fenceToken?: number } = {}): Promise<IPage> {
